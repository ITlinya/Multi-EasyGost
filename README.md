...
4. 添加代理使国内腾讯云，阿里云等服务器可用（禁国外IP的国内机不可用）
***
## 简介
...
* 启动脚本  
  `wget --no-check-certificate -O gost.sh https://proxy.lblog.net/https://raw.githubusercontent.com/ITLinya/Multi-EasyGost/master/gost.sh && chmod +x gost.sh && ./gost.sh`  
